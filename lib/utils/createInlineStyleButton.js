...
exports.default = function (_ref) {
  var style = _ref.style,
      styleToRemove = _ref.styleToRemove,
  ...
  return function (_Component) {
    ...
    function InlineStyleButton() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = InlineStyleButton.__proto__ || Object.getPrototypeOf(InlineStyleButton)).call.apply(_ref2, [this].concat(args))), _this), _this.toggleStyle = function (event) {
        ...
        var newEditorState = _draftJs.RichUtils.toggleInlineStyle(_this.props.getEditorState(), style);

        if (styleToRemove && !_this.styleIsActive() && _this.styleToRemoveIsActive()) {
          newEditorState = _draftJs.RichUtils.toggleInlineStyle(newEditorState, styleToRemove);
        }
      ...
      }, _this.styleToRemoveIsActive = function () {
        return _this.props.getEditorState().getCurrentInlineStyle().has(styleToRemove);
